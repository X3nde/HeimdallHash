...
$testId = "T08"
$name = "Tamaño declarado distinto del real"

try {
    Write-HHStep "$testId - $name"

    $pkgName = "HH_INVALID_SIZE_MISMATCH.zip"
    ...
    Wait-HHUntil -Description "Producto con tamaño incorrecto enviado a cuarentena." -TimeoutSeconds $config.DefaultTimeout -Condition {
    ...
    Add-HHResult -Config $config -TestId $testId -Name $name -Result "PASS" -Detail "Producto con tamaño incorrecto enviado a cuarentena."
